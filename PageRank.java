 ...
 * 1. read lines from pages.txt and create vertexes
 * 2. read lines from links.txt and add edges
 * 3. point passing
 * 4. decide Top 10
...
public class PageRank {
	...
	final static int bestX = 10; //decide Top X(10)
	final static double rate = 0.8; //give (rate * my_point / number of links) to link destinations
	...
	public static void main(String[] args) {
		...
		/* 5. repeat (3.point passing & 4.decide Top 10) several times */
